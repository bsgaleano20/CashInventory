                                ...
                                <div class="btn-group me-2" role="group" aria-label="First group">
                                    ...
                                    <tbody>
                                        <tr class="table-light">
                                            <td class="table-light"><input type="text" class="form-control" name="id" placeholder="Nombre del Movimiento"></td>
                                        ...
                                        <tbody>
                                            @if ($id == 'ruta')
                                                <tr class="table-light">
                                                    ...
                                                    <td class="table-light"><a role="button" class="btn btn-warning" href="/gestion_movimientos/crear_movimiento/buscar_producto" ><i class="bi bi-search"></i></a></td>
                                            ...
                                            @else
                                                {{-- <tr class="table-light">
                                                    <td class="table-light"><input type="text" class="form-control" name="nombre_producto" value=" 
                                                        @if($producto)
                                                    ...
                                                    <td class="table-light"><input type="number" class="form-control" name="valor_movimiento" placeholder="Valor total del producto"></td>
                                                    <td class="table-light"><input type="date" class="form-control" name="fecha_movimiento" placeholder="Fecha"></td>
                                                    <td class="table-light"><a role="button" name="buscarProducto" class="btn btn-warning" href="/gestion_movimientos/crear_movimiento/buscar_producto" ><i class="bi bi-search"></i></a></td>
                                                    <td class="table-light"><button type="button" class="btn btn-success"><i class="bi bi-clipboard2-plus-fill"></i></button></td>
                                                    <td class="table-light"><button type="button" class="btn btn-danger"><i class="bi bi-x-lg"></i></button></td>
                                                </tr> --}}
                                                <tr class="table-light">
